...
const Signin = () => {
      ...
      <Link to='/'><img src={logo} alt="" className=" h-10" /></Link>
        ...
        <div className="flex gap-5 items-center justify-between">
          ...
          <div className="">
            <Link to="/forgot-password" className=" text-sm  bg-gradient-to-r from-[#f66830] to-[#fe5340] text-transparent bg-clip-text">
      ...
      <path fillRule="evenodd" d="M7.5 3.75A1.5 1.5 0 006 5.25v13.5a1.5 1.5 0 001.5 1.5h6a1.5 1.5 0 001.5-1.5V15a.75.75 0 011.5 0v3.75a3 3 0 01-3 3h-6a3 3 0 01-3-3V5.25a3 3 0 013-3h6a3 3 0 013 3V9A.75.75 0 0115 9V5.25a1.5 1.5 0 00-1.5-1.5h-6zm10.72 4.72a.75.75 0 011.06 0l3 3a.75.75 0 010 1.06l-3 3a.75.75 0 11-1.06-1.06l1.72-1.72H9a.75.75 0 010-1.5h10.94l-1.72-1.72a.75.75 0 010-1.06z" clipRule="evenodd" />
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          Return to {' '}
          <Link to="/signup" className="font-medium bg-gradient-to-r from-[#f66830] to-[#fe5340] text-transparent bg-clip-text">
            Register
          </Link>
        </p>
      </form>
